              ...
              <div className="flex justify-center ">
                    <div className="w-[50%] h-[60px] bg-gray-100/100 rounded-2xl py-6  flex justify-between items-center px-4 shadow-xl border mt-4">
                        ...
                        <div className="flex items-center justify-center">
                            ...
                            <ul className="pl-3 flex gap-x-4 border-l text-purple-900/100  cursor-pointer text-sm font-medium  border-gray-300">
                        ...
                        {/* right  */}
                        <div>
                            <Button variant="secondary" className="bg-white hover:bg-white shadow-md shadow-gray-300 hover:scale-105 text-purple-900/100 ease-in-out transition-all duration-200 rounded-xl">Log in</Button>
                        </div>
                    </div>
              </div>
          </div>
